...
if __name__ == '__main__':
    ...
    Xvalue = raw_input("Target Reg:")
    TARGET_REG = int(Xvalue)
    ...
    while(1):		
        regResponse = mx28.get_reg(4,ins=READDATA,regstart=TARGET_REG,rlength=1)
        print "Target ("+str(TARGET_REG)+")=> " + str(regResponse)
        file.write(str(regResponse[0]) +"\n")
    file.close()
